...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/dashboard', icon: LayoutDashboard, roles: ['admin', 'doctor', 'staff'] },
    { name: 'Patients', href: '/patients', icon: Users, roles: ['admin', 'doctor', 'staff'] },
    ...
    { name: 'Billing', href: '/billing', icon: DollarSign, roles: ['admin', 'staff'] },
