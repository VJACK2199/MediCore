      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Schedule your appointment with Akruti Hospital. Choose your preferred doctor, upload medical reports, and get the care you need.
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="input"
                  rows="4"
                  placeholder="Please describe your medical problem in detail, when it started, and what makes it better or worse"
